...
(defn main []
  [:div
   {:className "fixed start w-screen h-screen bg-cover bg-center top-0"
...
"]
   [:div.absolute.left-50%.-translate-x-50%.bottom-24
    [:button.block.w-32
     {:on-click #(rf/dispatch [:navigate/the-map])}
